    ...
    <footer className="bg-primary text-white">
      ...
      <div className="border-t border-white/10">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-8 lg:px-12 py-5 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-white/50 text-xs">&copy; WCEIA International 2025</p>
          <p className="text-white/40 text-xs">
            Design &amp; Developed By:{" "}
            <a href="https://webspires.com.pk/?utm_source=wceia.org&utm_medium=footer" target="_blank" rel="noreferrer" className="hover:text-white/70 transition-colors">
              Webspires Pvt Ltd
            </a>
          </p>
        </div>
