        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-5">
              <Image src="/logo.png" alt="WCEIA Logo" width={52} height={52} className="object-contain" />
            </div>
            ...
            <div className="flex items-center gap-3">
              <a href="https://www.facebook.com/wceiaorg" target="_blank" rel="noreferrer" aria-label="Facebook"
                className="w-9 h-9 rounded-full flex items-center justify-center bg-white/10 text-white hover:bg-accent transition-all duration-200"
              >
          ...
          <div>
            <h3 className="font-bold text-white text-base mb-2">
              Quick Links
              <span className="block w-8 h-0.5 mt-2 rounded" style={{ backgroundColor: "#EF8B1D" }} />
            </h3>
            <ul className="space-y-3 mt-4">
              {quickLinks.map((item) => (
                <li key={item.label}>
                  <Link href={item.href}
                    className="text-white/70 hover:text-accent text-sm transition-colors duration-200 flex items-center gap-2"
                  >
                    <span className="w-1.5 h-1.5 rounded-full shrink-0" style={{ backgroundColor: "#EF8B1D" }} />
                    {item.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-white/70 mt-6">
              <li className="flex items-start gap-3">
                <svg className="w-4 h-4 mt-0.5 shrink-0" viewBox="0 0 24 24" fill="none" stroke="#EF8B1D" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" /><polyline points="22,6 12,13 2,6" /></svg>
                <a href="mailto:skh060697@gmail.com" className="hover:text-accent transition-colors">skh060697@gmail.com</a>
              </li>
              <li className="flex items-center gap-3">
                <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="none" stroke="#EF8B1D" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 16.92z" /></svg>
                <a href="tel:+19023882241" className="hover:text-accent transition-colors">+1 902 388 2241</a>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-4 h-4 mt-0.5 shrink-0" viewBox="0 0 24 24" fill="none" stroke="#EF8B1D" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z" /><circle cx="12" cy="10" r="3" /></svg>
                <a href="https://maps.app.goo.gl/bzi2KvyPwcDd119N9" target="_blank" rel="noreferrer" className="hover:text-accent transition-colors leading-relaxed">
                  18 Birkdale Crescent, Unit 2,<br />Halifax, Nova Scotia B3M1H5
                </a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-white/70 text-sm leading-relaxed mt-6 mb-5">
            ...
            <form className="flex flex-col gap-3" onSubmit={(e) => e.preventDefault()}>
              ...
              />
              <button type="submit"
                className="text-white px-5 py-2.5 rounded-lg text-sm font-semibold transition-all duration-200 hover:opacity-90"
